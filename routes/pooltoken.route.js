...
const poolTokenController = require('../controllers/pooltoken.controller');
...
router.post('/', userCheck, poolTokenController.create);
router.get('/', poolTokenController.getPoolTokens);
